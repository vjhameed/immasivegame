        ...
        return (
            <div className="nk-widget-post">
                <a href="blog-article.html" className="nk-post-image">
                    <img src="https://cdn-html.nkdev.info/goodgames/assets/images/post-1-sm.jpg" alt="" />
                </a>
                <h3 className="nk-post-title"><a href="blog-article.html">Smell magic in the air. Or maybe barbecue</a>
                </h3>
                <div className="nk-post-date"><svg className="svg-inline--fa fa-calendar-alt fa-w-14" aria-hidden="true"
